...
static const ProtobufCFieldDescriptor tutorial__person__phone_number__field_descriptors[3] =
{
  {
    "area_code",
    1,
    ...
    offsetof(Tutorial__Person__PhoneNumber, has_area_code),
    offsetof(Tutorial__Person__PhoneNumber, area_code),
    NULL,
    NULL,
    0,             /* flags */
  ...
  },
  {
    ...
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_INT32,
    offsetof(Tutorial__Person__PhoneNumber, has_number),
