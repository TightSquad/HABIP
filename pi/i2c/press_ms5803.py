...
class pressSensorMS5803(i2c):
	...
	def readAll (self):
		...
		Read the temperature (c/f), pressure (mBar, Pa), and calculate altitude (m/ft)
			RETURNS list of floats: [temp_c, temp_f, press_mbar, press_pa, altitude_m, altitude_ft]
		"""
		...
		P = (((d1_pressure * SENS) >> 21) - OFF) >> 15 		# Temperature compensated pressure (in Pascals --> 1mBar = 100 Pa) (0...6000mbar with 0.03mbar resolution)
